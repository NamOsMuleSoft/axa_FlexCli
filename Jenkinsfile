        ...
        stage('Check API version') {
            steps {
                script {
                    ...
                    status = sh(returnStatus: true, script: "anypoint-cli-v4 exchange:asset:list --client_id 68c10e4c2fc44fab9f968b414b28735 --client_secret e0d581990cFB45029fDd6D09F9176501 --organization 21448f2a-f782-42b5-b7ea-3c78f2cd1c5d -o json")
